...
const CheckOut = () => {
    ...
    useEffect(() => {
        ...
        const url = `https://mighty-earth-48217.herokuapp.com/product/${id}`;
        fetch(url)
            .then(res => res.json())
            .then(data => {
    ...
    return (
        <div className="container shadow px-4 pt-4 my-4" style={{ borderRadius: "15px" }}>
            <Table hover responsive  className="container-table-text">
                <thead>
                    <tr>
                        <th>Description</th>
                        <th>Quantity</th>
